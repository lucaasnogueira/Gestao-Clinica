    ...
    <div className="space-y-5 animate-fade-in max-w-5xl">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-primary/10 border border-primary/20 flex items-center justify-center text-2xl font-bold text-primary flex-shrink-0">
              {patient.fullName[0].toUpperCase()}
            </div>
            <div>
              <h1 className="text-2xl font-bold">{patient.fullName}</h1>
              <div className="flex items-center gap-3 mt-0.5">
                <span className="text-xs text-muted-foreground font-mono">{formatCPF(patient.cpf)}</span>
                {patient.bloodType && (
                  <span className="text-xs font-bold font-mono bg-red-50 text-red-700 border border-red-200 px-1.5 py-0.5 rounded">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-card border border-border rounded-xl p-4">
            <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wide mb-3">Ações Rápidas</p>
            <div className="space-y-1.5">
              <Link
                href={`/dashboard/appointments/new?patientId=${patient.id}`}
                className="flex items-center gap-2.5 px-4 py-2.5 rounded-lg bg-primary/8 hover:bg-primary/12 text-primary text-sm font-medium transition-colors"
              >
              ...
              <Link
                ...
                className="flex items-center gap-2.5 px-4 py-2.5 rounded-lg hover:bg-muted text-foreground text-sm transition-colors"
              >
